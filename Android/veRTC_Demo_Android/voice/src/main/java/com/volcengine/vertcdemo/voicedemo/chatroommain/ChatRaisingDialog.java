...
import com.volcengine.vertcdemo.core.eventbus.RefreshListenerEvent;
import com.volcengine.vertcdemo.core.eventbus.RefreshRaiseHandEvent;
...
public class ChatRaisingDialog extends AppCompatDialog {
    ...
    private final List<ChatUserInfo> mRaiseData = new LinkedList<>();
    private final List<ChatUserInfo> mListenerData = new LinkedList<>();
    ...
    private static class RaisingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private final List<ChatUserInfo> mData = new LinkedList<>();
